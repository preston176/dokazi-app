    ...
    useEffect(() => {
        async function fetchDocs() {
            ...
            if (typeof docs === "string") {
                setDocuments([]);
            } else if (docs && docs.success && Array.isArray(docs.data)) {
                setDocuments(
                    docs.data.map((d) => ({
                        docId: d.docId,
                        docTitle: d.docTitle,
            ...
            <Card className="lg:hidden mb-6 bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-900 dark:to-green-900 border-blue-200 dark:border-blue-800">
                <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <Badge variant="secondary" className="bg-gray-800 dark:bg-gray-200 text-white dark:text-black text-xs">
                            3 left
                        </Badge>
                    </div>
                    <div className="grid grid-cols-2 gap-3 mb-3">
                        <div className="text-center">
                            <div className="text-lg font-bold text-green-600 dark:text-green-300">3</div>
                            <div className="text-xs text-green-700 dark:text-green-400">Remaining</div>
                        </div>
                        <div className="text-center">
                            <div className="text-lg font-bold text-blue-600 dark:text-blue-300">0</div>
                    ...
                    {hasDrafts && (
                        <>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                                {drafts.map((draft) => (
                                    <DocumentCard key={draft.docId} doc={draft} />
                                ))}
                            </div>
                        </>
                    )}
