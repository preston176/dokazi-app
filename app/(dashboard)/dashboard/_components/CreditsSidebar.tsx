        ...
        <div className="grid grid-cols-2 gap-3">
          <Card className="bg-green-50 dark:bg-green-900 border-green-200 dark:border-green-700">
            <CardContent className="p-3 lg:p-4 text-center">
              ...
              <div className="text-xs lg:text-sm text-green-700 dark:text-green-400">Remaining</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-blue-50 dark:bg-blue-900 border-blue-200 dark:border-blue-700">
            <CardContent className="p-3 lg:p-4 text-center">
              ...
              <div className="text-xs lg:text-sm text-blue-700 dark:text-blue-400">Used this month</div>
            </CardContent>
          </Card>
        </div>
